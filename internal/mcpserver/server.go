...
权限范围：
- 只读 Key（read_only）可调用 GET 查询类工具及 5 个读探测 POST 工具（test_ca_provider/test_certificate_config/parse_certificate/validate_import/preview_config）；其余写工具（POST/PUT/DELETE）需非只读 Key
