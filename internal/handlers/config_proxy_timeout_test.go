...
func TestConfigProxyTimeouts_roundtrip_through_PUT_and_GET(t *testing.T) {
	...
	updateRequest := httptest.NewRequest(http.MethodPut, "/config", strings.NewReader(`{"source":"caddy","proxy_dial_timeout":11,"proxy_response_header_timeout":22,"proxy_read_timeout":33,"proxy_write_timeout":44,"proxy_stream_timeout":55}`))
	...
	if body.Data.ProxyDialTimeout != 11 || body.Data.ProxyResponseHeaderTimeout != 22 || body.Data.ProxyReadTimeout != 33 || body.Data.ProxyWriteTimeout != 44 || body.Data.ProxyStreamTimeout != 55 {
