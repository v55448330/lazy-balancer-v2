...
var apiDocRoutes = []apiDocRoute{
	...
	{"GET", "/security/crs", "安全", "CRS 规则集信息", "", `{"version":"v4.28.0","auto_update":true,"rule_count":832}`, []string{"500 数据库故障", "401 unauthenticated"}, ""},
	...
	{"GET", "/security/ip2region", "安全", "IP2Region数据库信息", "", `{"version":"v3.17.0","auto_update":true,"update_status":"success"}`, []string{"500 数据库故障", "401 unauthenticated"}, ""},
