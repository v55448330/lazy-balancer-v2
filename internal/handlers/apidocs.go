...
var apiDocRoutes = []apiDocRoute{
	...
	{"GET", "/security/threat-lib", "安全", "威胁情报库源列表与条目合计数", "", `{"sources":[{"id":1,"name":"ustc","display_name":"中科大恶意 IP（USTC）","url":"https://blackip.ustc.edu.cn/list.php?txt","format":"plain","update_enabled":true,"apply_enabled":true,"entry_count":14030,"version":"2026.09.23","update_status":"success","message":"","last_checked":"2026-09-23 02:00:00","next_update":"2026-09-24 02:00:00"}],"total_entries":19144,"schedule_days":[1,2,3,4,5,6,7],"schedule_time":"04:00"}`, []string{"401 unauthenticated", "500 数据库故障"}, "内置只读三源（USTC 黑 IP/FireHOL level1/ET Compromised）；total_entries=三源条目合计。版本=最近成功更新日期（YYYY.MM.DD）。schedule_days/schedule_time 为任务级定时更新排程（星期集 1=周一…7=周日 + HH:MM，时区遵循基础设置）。"},
