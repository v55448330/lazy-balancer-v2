...
func runMigrations() error {
	...
	newColumns := map[string]string{
		...
		"security_policies.rate_limit_response":        "TEXT NOT NULL DEFAULT '429'",
		...
		"global_config.security_events_retention_days": "INTEGER NOT NULL DEFAULT 30",
		"global_config.security_events_retention_max":  "INTEGER NOT NULL DEFAULT 100000",
		"security_events.rule_name":                    "TEXT NOT NULL DEFAULT ''",
		"security_events.policy_name":                  "TEXT NOT NULL DEFAULT ''",
	}
